...
export const CommonIcons = () => (
    <SvgSprite>
        ...
        <symbol id="disk" viewBox="0 0 24 24" fill='none'>
        ...
        <symbol id="arrow-back" viewBox="0 0 52 52">
